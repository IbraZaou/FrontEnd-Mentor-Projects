...
const dataProject = [
    {
        ...
        description: "Application utilisant une API pour récupérer la devise et des drapeaux afin de convertir n'importe quelle devise.",
    ...
    },
    {
        ...
        main: '<i class="fa-brands fa-php fa-xl"></i>',
        feeling: '😭',
    ...
    },
    {
        ...
        main: '<i class="fa-brands fa-symfony fa-xl"></i>',
        feeling: '😭',
