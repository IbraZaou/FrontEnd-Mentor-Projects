...
const dataProject = [
    {
        ...
        description: "Composant QR CODE that brings you to FrontEndMentor's website",
        title: '#1 - QR CODE',
        technologie: <>
            <i className="fa-brands fa-html5 fa-xl"></i> - <i className="fa-brands fa-css3-alt fa-xl"></i> - <i class="fa-brands fa-js fa-xl"></i>
        </>,
        difficulty: '😄',
        githubLink: 'https://github.com/IbraZaou/FrontEnd-Mentor-Projects/tree/main/front-end-project/src/projects/%231%20-%20QR_CODE',
    },
    {
        id: 2,
    ...
    },
    {
        ...
        description: 'A player including all my favourite Lofi Music',
        title: '#3 - LOFI MUSIC PLAYER',
        technologie: <>
            <i className="fa-brands fa-html5 fa-xl"></i> - <i className="fa-brands fa-css3-alt fa-xl"></i> - <i class="fa-brands fa-js fa-xl"></i>
        </>,
        difficulty: '😶',
